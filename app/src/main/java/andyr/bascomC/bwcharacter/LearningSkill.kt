...
class LearningSkill(mName: String, var aptitude: Int = 0, mExponent: Int = 0, viewType: Int = 0, mShade: Int = 0, mTests: Int = 0) : SkillObject(mName, mapOf(
...
), mExponent, viewType, mShade, mTests) {
