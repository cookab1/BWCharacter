 ...
 */
class Skill(var mName: String, var mExponent: Int = 0, var viewType: Int = 0, var mShade: Int = 0, var mTests: Int = 0) {
    ...
    private val testsToImage: HashMap<Int, Int> = hashMapOf(
        ...
        440 to R.drawable.test440, 441 to R.drawable.test441, 442 to R.drawable.test442, 443 to R.drawable.test443)

    val mID: UUID = UUID.randomUUID()

    //Helper functions
    fun getTestsImage(tests: Int): Int {
        return testsToImage[tests]!!
    }
